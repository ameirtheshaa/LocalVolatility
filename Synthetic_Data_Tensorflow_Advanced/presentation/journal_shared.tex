% journal_shared.tex — circulation copy (manuscript-vs-code note removed) of the journal deck for the LocalVolatility / Dupire-PINN project
...
% ===================== S7: IBP diagnostic =====================
\daydivider{2026\text{-}05\text{-}25 $\to$ 05\text{-}29}{IBP diagnostic \& the $\tilde\varphi$ bug}{three-way mean test; $K{=}0$ penalty retrain; PR\#2 merged 05\text{-}29}
...
\begin{frame}{Open decisions --- to resolve here, together}
  \begin{itemize}
    \item \gold{Manuscript $K=0$ fix:} keep the current ansatz plus the $\lambda_{k_0}$ boundary penalty,
          or adopt a parity-type ansatz that attains $\tilde\varphi=1$ at $K=0$ by construction?
...
\begin{frame}{Appendix E --- code, reproduction \& provenance}
  \begin{itemize}\scriptsize
    ...
    \item \textbf{Provenance:} this deck merges \texttt{main.tex} (\S7 IBP arc),
          \texttt{density\_story.tex} (App.~A derivation),
